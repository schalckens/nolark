...
function gestionAlcoolemie() {
    // Déclaration et affectation des variables vbn
...
/**
 *
 *let alcoolemie = document.getElementById('alcoolemie')
 *let amende = document.getElementById('amende')
 *let sanction = document.getElementById('sanction')
/**
...
/**
 * Fonction qui retourne le coefficient de diffusion de l'alcool
 * pour le sexe cocher
 *
 * @param sexe
 * @returns {number}
